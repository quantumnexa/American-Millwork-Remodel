...
const BathroomHero = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const custom = { page: "bathroom-hero", utm_source, message };
    setStatus("pending");
    try {
  ...
  return (
    <>
                      ...
                      <div className="hero-col">
                        <div className="custom-font">
                          ...
                          <h1 className="words chars splitting" style={{ fontSize: "55px", lineHeight: "1.1" }}>
                            <Link href="#">Luxury Bathroom Remodeling & Spa Transformations</Link>
                          </h1>
                        </div>
                        <p className="mt-10">
                          Elevate your home with a premium bathroom remodel. From modern walk-in showers to custom vanities and high-end tile work, we create spaces for relaxation and style.
                        </p>
                      </div>
      ...
      <style jsx>{`
        ...
        .bathroom-hero .cta__slider-wrapper {
          background-color: transparent !important;
          background-image: none !important;
        }
