          ...
          <div className="col-lg-6 valign order2 order-lg-1">
            <div className="content-side pr-60">
              ...
              <div className="row points-grid">
                {(props.points || [
                  { icon: "flaticon-home-1", text: "Bathroom design focus" },
                  { icon: "flaticon-renovation", text: "Premium fixture supply" },
                  { icon: "flaticon-computer", text: "Remote quoting system" },
                  { icon: "flaticon-sketch", text: "Detailed bathroom plans" },
                  { icon: "flaticon-plan", text: "Nationwide delivery" },
...
export default BathroomAboutUs8;
