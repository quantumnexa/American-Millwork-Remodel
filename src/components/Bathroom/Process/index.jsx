          ...
          >
            <div className="item">
              ...
              <div className="cont">
                ...
                <p>Submit your bathroom measurements and photos online.</p>
              </div>
            </div>
          </div>
          <div
          ...
          >
            <div className="item">
              ...
              <div className="cont">
                ...
                <p>Our designers review your space and fixtures requirements.</p>
              </div>
            </div>
          </div>
          <div
          ...
          >
            <div className="item">
              ...
              <div className="cont">
                ...
                <p>We provide a custom quote for materials and finishes.</p>
              </div>
            </div>
          </div>
          <div
          ...
          >
            <div className="item">
              ...
              <div className="cont">
                ...
                <p>We coordinate delivery and expert local installation.</p>
              </div>
            </div>
          </div>
          <div
          ...
          >
            <div className="item">
              ...
              <div className="cont">
                ...
                <p>Enjoy your new spa-like bathroom experience.</p>
              </div>
            </div>
          </div>
        </div>
...
export default BathroomProcess;
