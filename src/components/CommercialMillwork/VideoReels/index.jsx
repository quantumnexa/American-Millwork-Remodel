...
const CommercialVideoReels = () => {
  // Sample video data - Replace these URLs with your actual reel videos
  const videos = [
    {
      id: 1,
      url: "/assets/img/videos/commercial/1.mp4",
      poster: "/assets/img/portfolio/1.jpg",
      
    },
    {
      id: 2,
      url: "/assets/img/videos/commercial/2.mp4",
      poster: "/assets/img/portfolio/2.jpg",
      
    },
    {
      id: 3,
      url: "/assets/img/videos/commercial/3.mp4",
      poster: "/assets/img/portfolio/3.jpg",
    },
    {
      id: 4,
      url: "/assets/img/videos/commercial/4.mp4",
      poster: "/assets/img/portfolio/4.jpg",
      
    },
    {
      id: 5,
      url: "/assets/img/videos/commercial/5.mp4",
...
export default CommercialVideoReels;