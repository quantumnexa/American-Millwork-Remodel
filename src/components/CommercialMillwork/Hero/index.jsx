...
const CommercialMillworkHero = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const custom = { page: "commercial-millwork-hero", utm_source, message };
    setStatus("pending");
    try {
      const res = await fetch("/api/leads", {
        ...
        body: JSON.stringify({
          ...
          email,
          phone,
          service_type: "Commercial Millwork",
          source: "website",
          custom,
        }),
      });
  ...
  return (
    <>
      <header className="slid-half commercial-millwork-hero">
        <div className="cta__slider-wrapper nofull">
          <div className="media-wrapper slide-inner valign">
            <div className="bg-img" data-overlay-dark="5">
              <Image
                src="/assets/img/hero/commercial.png"
                alt="Commercial Millwork Hero"
                layout="fill"
                objectFit="cover"
                priority={true}
              />
                      ...
                      <div className="hero-col">
                        <div className="custom-font">
                          ...
                          <h1 className="words chars splitting" style={{ fontSize: "55px", lineHeight: "1.1" }}>
                            <Link href="#">Commercial Millwork Built for Performance & Presence</Link>
                          </h1>
                        </div>
                        <p className="mt-10">
                          High-quality custom millwork solutions for offices, retail spaces, and commercial environments—crafted to elevate your brand, improve functionality, and deliver lasting durability.
                        </p>
                      </div>
                      <div className="hero-form">
                        <h3 className="form-title">Get Free Quotes in 10 Minutes</h3>
                        <form onSubmit={handleSubmit}>
                          ...
                          <button className="btn-curve btn-color hf-btn" type="submit" disabled={status === "pending"}>
                            <span>{status === "pending" ? "Submitting..." : "Get Free Quotes in 10 Minutes"}</span>
                          </button>
...
export default CommercialMillworkHero;