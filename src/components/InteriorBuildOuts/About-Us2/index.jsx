          ...
          <div className="col-lg-6 valign">
            ...
            >
              ...
              <h2 className="mb-20 playfont">
                Premium <span className="text-highlight">Interior Build-Outs</span> and <span className="text-highlight">Custom Millwork</span>
              </h2>
              <p>
                We specialize in complete interior build-out transformations, combining high-end material supply with expert project coordination. Whether you are looking for modern commercial spaces or residential interior finishes, our system simplifies the build-out process from initial measurements to final installation.
              </p>
            </div>
          </div>
