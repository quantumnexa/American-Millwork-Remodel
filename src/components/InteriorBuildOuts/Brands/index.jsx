        ...
        <div className="section-head text-center">
          <div className="row justify-content-center">
            <div className="col-lg-8 col-md-10">
              ...
              <p>Trusted manufacturers and suppliers we collaborate with to deliver quality interiors and custom finishes.</p>
            </div>
          </div>
        </div>
        <Swiper
...
export default InteriorBuildOutsBrands;