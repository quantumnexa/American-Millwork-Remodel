          ...
          >
            <div className="item">
              ...
              <div className="cont">
                ...
                <p>Share your space and requirements</p>
              </div>
            </div>
          </div>
          <div
          ...
          >
            <div className="item">
              ...
              <div className="cont">
                ...
                <p>Choose stock or customize your design</p>
              </div>
            </div>
          </div>
          <div
          ...
          >
            <div className="item">
              ...
              <div className="cont">
                ...
                <p>Get a clear quote,no surprises</p>
              </div>
            </div>
          </div>
          <div
          ...
          >
            <div className="item">
              ...
              <div className="cont">
                ...
                <p>Fast delivery or precision build</p>
              </div>
            </div>
          </div>
          <div
          ...
          >
            <div className="item">
              ...
              <div className="cont">
                ...
                <p>Install and enjoy your new space</p>
              </div>
            </div>
          </div>
        </div>
