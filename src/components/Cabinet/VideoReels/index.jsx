...
const CabinetVideoReels = () => {
  // Sample video data - Replace these URLs with your actual reel videos
  const videos = [
    {
      id: 1,
      url: "/assets/img/videos/cabinet/1.mp4",
      poster: "/assets/img/portfolio/1.jpg",
      
    },
    {
      id: 2,
      url: "/assets/img/videos/cabinet/2.mp4",
      poster: "/assets/img/portfolio/2.jpg",
      
    },
    {
      id: 3,
      url: "/assets/img/videos/cabinet/3.mp4",
      poster: "/assets/img/portfolio/3.jpg",
    },
    {
      id: 4,
      url: "/assets/img/videos/cabinet/4.mp4",
      poster: "/assets/img/portfolio/4.jpg",
      
    },
    {
      id: 5,
      url: "/assets/img/videos/cabinet/5.mp4",
          ...
          <div className="col-lg-4">
            <div className="section-head mb-0">
              ...
              <h2 className="mb-20 playfont" style={{ fontSize: "45px", fontWeight: "600", color: "#111", lineHeight: "1.2" }}>
                Where Smart Design <br/> Meets Real-Life Function
              </h2>
              <p className="text-gray mb-40">
                Explore how our stock and custom cabinet solutions transform everyday spaces into functional, modern kitchens,without overcomplicating the process.
              </p>
...
export default CabinetVideoReels;