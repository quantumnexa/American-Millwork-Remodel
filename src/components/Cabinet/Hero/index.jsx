...
const CabinetHero = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const custom = { page: "cabinet-hero", utm_source, message };
    setStatus("pending");
    try {
      const res = await fetch("/api/leads", {
        ...
        body: JSON.stringify({
          ...
          email,
          phone,
          service_type: "Cabinet Remodeling",
          source: "website",
          custom,
        }),
      });
  ...
  return (
    <>
      <header className="slid-half cabinet-hero">
        <div className="cta__slider-wrapper nofull">
          <div className="media-wrapper slide-inner valign">
            <div className="bg-img" data-overlay-dark="5">
              <Image
                src="/assets/img/hero/cabinets.png"
                alt="Kitchen Hero"
                layout="fill"
                objectFit="cover"
                priority={true}
                      ...
                      <div className="hero-col">
                        <div className="custom-font">
                          ...
                          <h1 className="words chars splitting" style={{ fontSize: "55px", lineHeight: "1.1" }}>
                            <Link href="#">Transform Your Space with Premium Cabinets</Link>
                          </h1>
                        </div>
                        <p className="mt-10">
                          Ready-to-install or fully customizable,designed to fit your home, your style, and your timeline. <br/><br/>
                          From fast, budget-friendly stock cabinets to fully tailored solutions, we deliver quality craftsmanship without the wait.
                        </p>
