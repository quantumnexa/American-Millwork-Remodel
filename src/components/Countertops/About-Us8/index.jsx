              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="img mb-30">
                    <img src={(props.image1 || "/assets/img/service/cabinet/7.png")} alt="" style={{ width: '100%', borderRadius: '10px', height: '400px', objectFit: 'cover' }} loading="lazy" />
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="img mb-30" style={{ marginTop: '50px' }}>
                    <img src={(props.image2 || "/assets/img/service/cabinet/9.png")} alt="" style={{ width: '100%', borderRadius: '10px', height: '400px', objectFit: 'cover' }} loading="lazy" />
                  </div>
                </div>
              </div>
            </div>
