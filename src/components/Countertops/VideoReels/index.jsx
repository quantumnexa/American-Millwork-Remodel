...
const CountertopsVideoReels = () => {
  // Sample video data - Replace these URLs with your actual reel videos
  const videos = [
    {
      id: 1,
      url: "/assets/img/videos/countertops/1.mp4",
      poster: "/assets/img/portfolio/1.jpg",
      
    },
    {
      id: 2,
      url: "/assets/img/videos/countertops/2.mp4",
      poster: "/assets/img/portfolio/2.jpg",
      
    },
    {
      id: 3,
      url: "/assets/img/videos/countertops/3.mp4",
      poster: "/assets/img/portfolio/3.jpg",
    },
    {
      id: 4,
      url: "/assets/img/videos/countertops/4.mp4",
      poster: "/assets/img/portfolio/4.jpg",
      
    },
    {
      id: 5,
      url: "/assets/img/videos/countertops/5.mp4",
          ...
          <div className="col-lg-4">
            <div className="section-head mb-0">
              ...
              <h2 className="mb-20 playfont" style={{ fontSize: "45px", fontWeight: "600", color: "#111", lineHeight: "1.2" }}>
                Where Style Meets <br/> Everyday Durability
              </h2>
              <p className="text-gray mb-40">
                See how our countertops transform kitchens and bathrooms into functional, beautiful spaces. Built to handle daily use while elevating the entire look of your home.
              </p>
...
export default CountertopsVideoReels;