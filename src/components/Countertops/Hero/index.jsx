...
const CountertopsHero = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const custom = { page: "countertops-hero", utm_source, message };
    setStatus("pending");
    try {
      const res = await fetch("/api/leads", {
        ...
        body: JSON.stringify({
          ...
          email,
          phone,
          service_type: "Countertop Remodeling",
          source: "website",
          custom,
        }),
      });
  ...
  return (
    <>
      <header className="slid-half countertops-hero">
        <div className="cta__slider-wrapper nofull">
          <div className="media-wrapper slide-inner valign">
            <div className="bg-img" data-overlay-dark="5">
              <Image
                src="/assets/img/hero/countertops.png"
                      ...
                      <div className="hero-col">
                        <div className="custom-font">
                          ...
                          <h1 className="words chars splitting" style={{ fontSize: "55px", lineHeight: "1.1" }}>
                            <Link href="#">Upgrade Your Space with Premium Countertops</Link>
                          </h1>
                        </div>
                        <p className="mt-10">
                          From ready-to-install options to fully custom designs, we deliver countertops that fit your style, your space, and your timeline—without the hassle.
                        </p>
